...
main()
{
      ...
      char c;
      float wait_time = 2, turnaround_time = 0, average_waiting_time, average_turnaround_time;
      ...
      for(time = process_queue[0].arrival_time; time < burst_time;)
      {
            ...
            printf("\n%c\t\t%d\t\t%d\t\t%d\t\t%d", process_queue[largest].process_name, process_queue[largest].arrival_time, 
			process_queue[largest].burst_time, process_queue[largest].priority, process_queue[largest].waiting_time);
      }
}
